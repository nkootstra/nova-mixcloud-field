...
Nova.booting(function (Vue, router) {
    router.addRoutes([{
        name: 'nova-mixcloud-field',
        path: '/nova-mixcloud-field',
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Nova Mixcloud Field")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-components/NovaMixcloudField/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
